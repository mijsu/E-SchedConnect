...
export default function Professors() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (result) => {
      ...
      // Show credentials modal with the temporary password
      setCredentials({
        email: result.email,
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isCredentialDialogOpen} onOpenChange={setIsCredentialDialogOpen}>
        <DialogContent data-testid="dialog-credentials">
          <DialogHeader>
            <DialogTitle>Professor Login Credentials</DialogTitle>
            <DialogDescription>
              Share these credentials with the professor so they can log in for the first time
            </DialogDescription>
          </DialogHeader>

          <Alert>
            <AlertDescription>
              The professor must use these credentials to log in. They should change their password after their first login.
            </AlertDescription>
          </Alert>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-muted p-3 rounded-md text-sm">
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Copy and paste these credentials to send via email or secure message</li>
                  <li>Professor can use these to log in at the login page</li>
                  <li>They should change their password on first login for security</li>
                </ul>
              </div>
            </div>
          )}
          ...
          <DialogFooter>
            <Button onClick={() => setIsCredentialDialogOpen(false)} data-testid="button-close-credentials">
              Done
            </Button>
          </DialogFooter>
        </DialogContent>
